...
WORDLIST_FILENAME = "/home/human/edX/6.00.1x/Python Problem Sets/PS4 Scrabble/words.txt"
...
#not sure why the below is here, as it doesn't match the desired output
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand) > 0:
        ...
        displayHand(hand)
        # Ask user for input
        msg = raw_input('Enter word, or a "." to indicate that you are finished: ').lower()
        ...
        # Otherwise (the input is not a single period):
            ...
            if not isValidWord(msg, hand, wordList):
            ...
            # Otherwise (the word is valid):
                ...
                wordscore = getWordScore(msg,n)
                handscore += wordscore
                print '"'+msg+'" earned '+str(wordscore)+' points. Total: '+str(handscore)+' points'
                print
                # Update the hand 
                hand = updateHand(hand, msg)
